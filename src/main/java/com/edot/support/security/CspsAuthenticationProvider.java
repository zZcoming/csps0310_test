...
public class CspsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    private CspsUserDetailsService cspsUserDetailsService;

    public CspsAuthenticationProvider() {
    ...
    protected void doAfterPropertiesSet() throws Exception {
        Assert.notNull(this.cspsUserDetailsService, "A CspsUserDetailsService must be set");
    }
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        try {
            ...
            loadedUser = this.getCspsUserDetailsService().loadUserByUsername(username, password);
    ...
    public void setCspsUserDetailsService(CspsUserDetailsService cspsUserDetailsService) {
        this.cspsUserDetailsService = cspsUserDetailsService;
    }

    protected CspsUserDetailsService getCspsUserDetailsService() {
        return cspsUserDetailsService;
    }
}
